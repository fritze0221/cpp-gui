...
namespace {
struct qt_meta_tag_ZN5TrainE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN5TrainE = QtMocHelpers::stringData(
    "Train",
    "onButtonClicked",
    "",
    "buttonIdentifier",
...
Q_CONSTINIT static const uint qt_meta_data_ZN5TrainE[] = {
...
Q_CONSTINIT const QMetaObject Train::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5TrainE.offsetsAndSizes,
    qt_meta_data_ZN5TrainE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5TrainE_t,
        // Q_OBJECT / Q_GADGET
...
void Train::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onButtonPressed((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
...
void *Train::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5TrainE.stringdata0))
