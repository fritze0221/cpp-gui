...
static constexpr auto qt_meta_stringdata_ZN6SwitchE = QtMocHelpers::stringData(
    "Switch",
    "onButtonClicked",
    "",
    "buttonType"
...
Q_CONSTINIT static const uint qt_meta_data_ZN6SwitchE[] = {
...
Q_CONSTINIT const QMetaObject Switch::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6SwitchE.offsetsAndSizes,
    qt_meta_data_ZN6SwitchE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6SwitchE_t,
        // Q_OBJECT / Q_GADGET
...
void *Switch::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6SwitchE.stringdata0))
