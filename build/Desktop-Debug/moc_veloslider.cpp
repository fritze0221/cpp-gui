...
void veloSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->sendRampEvent(); break;
        case 3: _t->onValueChanged(); break;
        case 4: _t->onTimer(); break;
        case 5: _t->onScalePaintEvent(); break;
        case 6: _t->onRampPaintEvent(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (veloSlider::*)();
            if (_q_method_type _q_method = &veloSlider::sendRampEvent; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
